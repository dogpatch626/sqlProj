...
CREATE USER
IF NOT EXISTS 'admin1' @ 'localhost' IDENTIFIED WITH caching_sha2_password BY 'admin1' COMMENT 'Some information about Admin1';
	GRANT 'administrator'
		TO 'admin1' @ 'localhost';
...
CREATE USER
IF NOT EXISTS 'admin2' @ 'localhost' ATTRIBUTE '{"fname": "James", "lname": "Scott", "phone": "123-456-7890"}';
	GRANT 'administrator'
		TO 'admin2' @ 'localhost';
...
CREATE USER
IF NOT EXISTS 'Company1' @ 'localhost' IDENTIFIED WITH caching_sha2_password BY 'Company1' PASSWORD EXPIRE INTERVAL 180 DAY FAILED_LOGIN_ATTEMPTS 3 PASSWORD_LOCK_TIME 2;
	GRANT 'user'
		TO 'Company1' @ 'localhost';

CREATE USER

IF NOT EXISTS 'Company2' @ 'localhost' IDENTIFIED WITH mysql_native_password BY 'Company2'
