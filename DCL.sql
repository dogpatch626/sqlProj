...
Drop ROLE 'developer', 'administrator', 'user', 'all_mandatory_roles'@'localhost';
CREATE ROLE 'developer', 'administrator', 'user', 'all_mandatory_roles'@'localhost';

GRANT ALL ON CSCI362.* TO 'developer';
...
GRANT SELECT, INSERT, UPDATE, DELETE ON CSCI362.* TO 'administrator';

GRANT INSERT, UPDATE, ON CSCI362.Application TO 'user';
GRANT INSERT, UPDATE, ON CSCI362.Company_information TO 'user';
GRANT INSERT, UPDATE, ON CSCI362.Cyber_security_clearence TO 'user';
GRANT INSERT, UPDATE, ON CSCI362.Funding TO 'user';
GRANT INSERT, UPDATE, ON CSCI362.Address TO 'user';
GRANT INSERT, UPDATE, ON CSCI362.Company_sector TO 'user';
GRANT INSERT, UPDATE, ON CSCI362.Company_subsector TO 'user';
GRANT INSERT, UPDATE, ON CSCI362.Foreign_associates TO 'user';
GRANT INSERT, UPDATE, ON CSCI362.Investors TO 'user';

CREATE USER IF NOT EXISTS 'developer1'@'localhost' IDENTIFIED BY 'developer1';
GRANT 'developer' TO 'developer1'@'localhost';

CREATE USER IF NOT EXISTS 'developer2'@'localhost' IDENTIFIED BY 'developer2';
GRANT 'developer' TO 'developer2'@'localhost';
...
GRANT 'administrator' TO 'admin1'@'localhost';
...
GRANT 'administrator' TO 'admin2'@'localhost';
...
CREATE USER 'Company1'@'localhost' IDENTIFIED WITH caching_sha2_password BY 'Company1' PASSWORD EXPIRE INTERVAL 180 DAY FAILED_LOGIN_ATTEMPTS 3 PASSWORD_LOCK_TIME 2;
GRANT 'user' TO 'Company1'@'localhost';
...
GRANT 'user' TO 'Company2'@'localhost';
