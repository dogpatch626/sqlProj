...
SELECT insert into  FROM address;
SELECT insert into  FROM application;
SELECT insert into  FROM certifications_financials;
SELECT insert into  FROM company_information;
SELECT insert into  FROM company_sector;
SELECT insert into  FROM company_subsector;
SELECT insert into  FROM country;
SELECT insert into  FROM customer; 
SELECT insert into  FROM cyber_security_clearence;
SELECT insert into  FROM cyber_security_questions;
SELECT insert into  FROM foreign_associates;
SELECT insert into  FROM funding;
SELECT insert into  FROM imported_materials;
SELECT insert into  FROM investors;
SELECT insert into  FROM material; 
SELECT insert into  FROM naics_codes;
SELECT insert into  FROM negative_regulatory_actions;
SELECT insert into  FROM patents;
SELECT insert into  FROM revenue;
SELECT insert into  FROM sectors;
SELECT insert into  FROM states;
SELECT insert into  FROM subsectors;
